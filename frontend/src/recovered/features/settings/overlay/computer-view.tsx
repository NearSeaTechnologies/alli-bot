...
const BLOCKED_COPY = "Further computer updates and resets are disabled for this session. Restart Alli Bot after the computer is available again.";
...
export function SettingsComputerPanel({ state, actions }: SettingsComputerMount) {
  ...
  return (
    <SettingsGroup title="Alli Bot's Computer">
      {phase === "up-to-date" && !state.isRebuildBlocked ? (
        ...
        <SettingsComputerRow
          ...
          label="Update Alli Bot's Computer"
      ...
      <SettingsComputerRow
        ...
        label="Reset Alli Bot's Computer"
