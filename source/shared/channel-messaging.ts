...
export function renderChannelsSystemPrompt(
  ...
  const lines = [
    "Channels: outside messaging surfaces you can talk on, beyond this Alli Bot chat.",
