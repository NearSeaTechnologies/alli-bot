...
export function createDesktopPreloadBridge(options: {
  ...
  const desktop: Record<string, any> = {
    ...
    getHostPinnedAgents: () => edge("getHostPinnedAgents"),
    setHostPinnedAgents: (payload: { readonly pinnedAgentIds: readonly string[] }) => edge("setHostPinnedAgents", payload),
    getHostSidebarSections: () => edge("getHostSidebarSections"),
    setHostSidebarSections: (payload: unknown) => edge("setHostSidebarSections", payload),
    getAgentDefaultModel: () => edge("getAgentDefaultModel"),
    setAgentDefaultModel: (payload: unknown) => edge("setAgentDefaultModel", payload),
