...
import { getSandboxStatus } from "./box/local-docker-host-connector.js";
...
export function createMainEdgeHandlers(deps: MainEdgeDeps): HandlerMap {
  const handlers: HandlerMap = {
    ...
    getBoxRuntime: async () => ({ mode: "sandbox", status: await getSandboxStatus(String(Reflect.get(deps.settingsStore, "settingsPath"))) }),
